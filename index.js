...
function addGamesToPage(games) {
    ...
    for (let i = 0; i < games.length; i++) {
        const game = games[i];  // individual game object
...
We need your help to fund ${unfundedGamesCount === 1 ? "this amazing project" : "these amazing projects"}!`;
...
topGameElement.textContent = `Top Game: ${firstGame.name}`;
firstGameContainer.appendChild(topGameElement);

// do the same for the runner up item
const runnerUpElement = document.createElement("p");
runnerUpElement.textContent = `Runner-Up: ${secondGame.name}`;
secondGameContainer.appendChild(runnerUpElement)

/************************************************************************************
 *  Extra Feature: Search Functionality
 * Skills used: event listeners, filter, ternary operator
*/
...
searchInput.addEventListener("input", () => {
    ...
    filteredGames.length === 0
        ? gamesContainer.appendChild(document.createElement("p")).textContent = "No games found."
